 ...
 * generated in the br.com.swconsultoria.cte.schema_300.retEnviCTe package.
...
public class ObjectFactory {
    ...
    private final static QName _ProtCTeOS_QNAME = new QName("http://www.portalfiscal.inf.br/cte", "protCTe");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.com.swconsultoria.cte.schema_300.retEnviCTe
     */
     ...
     */
    @XmlElementDecl(namespace = "http://www.portalfiscal.inf.br/cte", name = "TProtCTeOS")
    public JAXBElement<TProtCTeOS> createTProcCTeOS(TProtCTeOS value) {
