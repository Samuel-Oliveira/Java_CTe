...
@XmlType(name = "TEnderFer", namespace = "http://www.portalfiscal.inf.br/cte", propOrder = {
    "xLgr",
    "nro",
    "xCpl",
    "xBairro",
...
public class TEnderFer {
    ...
    @XmlElement(name = "CEP", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
