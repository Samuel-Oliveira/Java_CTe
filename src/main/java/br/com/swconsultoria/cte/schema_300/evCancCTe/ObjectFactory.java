...
package br.com.swconsultoria.cte.schema_300.evCancCTe;
 ...
 * generated in the br.com.swconsultoria.cte.schema_300.evCancCTe package.
...
public class ObjectFactory {
    ...
    private final static QName _EnvEvento_QNAME = new QName("http://www.portalfiscal.inf.br/cte", "eventoCTe");
    private final static QName _ProcEvento_QNAME = new QName("http://www.portalfiscal.inf.br/cte", "procEvento");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.com.swconsultoria.cte.schema_300.evCancCTe
     */
    ...
    public JAXBElement<TEvento> createTEvento(TEvento value) {
        return new JAXBElement<TEvento>(_EnvEvento_QNAME, TEvento.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TRetEnvEvento }{@code >}}
     */
    @XmlElementDecl(namespace = "http://www.portalfiscal.inf.br/cte", name = "procEvento")
