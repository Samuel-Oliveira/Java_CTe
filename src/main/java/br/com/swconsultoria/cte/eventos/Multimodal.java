...
import br.com.swconsultoria.cte.schema_400.evRegMultimodal.TEvento;
import br.com.swconsultoria.cte.schema_400.evRegMultimodal.TRetEvento;
...
public class Multimodal {
    ...
    public static TRetEvento eventoMulti(ConfiguracoesCte config, TEvento enviEvento, boolean valida) throws CteException {
        ...
        try {
            ...
            xml = Eventos.enviarEvento(config, xml, ServicosEnum.MULTIMODAL, valida);
