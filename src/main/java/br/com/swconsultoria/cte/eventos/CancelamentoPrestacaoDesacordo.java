 ...
 */
public class CancelamentoPrestacaoDesacordo {

    CancelamentoPrestacaoDesacordo() {}

    public static TRetEvento eventoCancPrestacaoDesacordo(ConfiguracoesCte config, TEvento enviEvento, boolean valida) throws CteException {
