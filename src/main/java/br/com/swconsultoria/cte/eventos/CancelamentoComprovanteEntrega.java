 ...
 */
public class CancelamentoComprovanteEntrega {

    CancelamentoComprovanteEntrega() {}

    public static TRetEvento eventoCancComprovanteEntrega(ConfiguracoesCte config, TEvento enviEvento, boolean valida) throws CteException {
