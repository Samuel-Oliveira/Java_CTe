...
public class Epec {
    ...
    public static TRetEvento eventoEpec(ConfiguracoesCte config, TEvento enviEvento, boolean valida) throws CteException {
        ...
        try {
            ...
            xml = Eventos.enviarEvento(config, xml, ServicosEnum.EPEC, valida);
