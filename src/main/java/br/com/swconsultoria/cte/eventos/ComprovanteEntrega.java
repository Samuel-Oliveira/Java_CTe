...
import br.com.swconsultoria.cte.schema_400.evCECTe.TEvento;
import br.com.swconsultoria.cte.schema_400.evCECTe.TRetEvento;
...
public class ComprovanteEntrega {
    ...
    public static TRetEvento eventoComprovanteEntrega(ConfiguracoesCte config, TEvento enviEvento, boolean valida) throws CteException {
        ...
        try {
            ...
            xml = Eventos.enviarEvento(config, xml, ServicosEnum.COMPROVANTE_ENTREGA, valida);
