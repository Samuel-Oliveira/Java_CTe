 ...
 */
   ...
   public CteRecepcaoEventoStub(org.apache.axis2.context.ConfigurationContext configurationContext,
     ...
     */
    public CteRecepcaoEventoStub(String targetEndpoint) throws org.apache.axis2.AxisFault {
        this(null,targetEndpoint);
                     ...
                     */
                            ...
                            public  CteRecepcaoEventoStub.CteRecepcaoEventoResult cteRecepcaoEvento(

                                    CteRecepcaoEventoStub.CteDadosMsg cteDadosMsg0, CteRecepcaoEventoStub.CteCabecMsgE cteCabecMsg1)
        ...
        _operationClient.execute(true);
               ...
               org.apache.axis2.context.MessageContext _returnMessageContext = _operationClient.getMessageContext(
                ...
                org.apache.axiom.soap.SOAPEnvelope _returnEnv = _returnMessageContext.getEnvelope();
                                ...
                                Object object = fromOM(
                                             ...
                                             CteRecepcaoEventoStub.CteRecepcaoEventoResult.class,
                                              getEnvelopeNamespaces(_returnEnv));

                               
                                        return (CteRecepcaoEventoStub.CteRecepcaoEventoResult)object;
            ...
            if (faultElt!=null){
                if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"cteRecepcaoEvento"))){
                    ...
                    try{
                        String exceptionClassName = (String)faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"cteRecepcaoEvento"));
                        Class exceptionClass = Class.forName(exceptionClassName);
                        java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(String.class);
                        Exception ex = (Exception) constructor.newInstance(f.getMessage());
                        //message class
                        String messageClassName = (String)faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"cteRecepcaoEvento"));
                ...
                */
                public  void startcteRecepcaoEvento(
                        ...
                        final CteRecepcaoEventoCallbackHandler callback)
                        ...
                        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                            ...
                            try {
                                org.apache.axiom.soap.SOAPEnvelope resultEnv = resultContext.getEnvelope();
                                        ...
                                        (CteRecepcaoEventoStub.CteRecepcaoEventoResult)object);
    ...
    public static class Factory{
        ...
        */
        public static CteCabecMsgE parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            CteCabecMsgE object =
                new CteCabecMsgE();
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   String namespacePrefix = registerPrefix(xmlWriter,"http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento");
    ...
    public static class Factory{
        ...
        *                If this object is a complex type, the reader is positioned at the end element of its outer element
        */
        public static CteRecepcaoEventoResult parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
    ...
    public static class Factory{
        ...
        *                If this object is a complex type, the reader is positioned at the end element of its outer element
        */
        public static CteCabecMsg parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            CteCabecMsg object =
                new CteCabecMsg();
    ...
    public static class Factory{
        ...
        *                If this object is a complex type, the reader is positioned at the end element of its outer element
        */
        public static CteDadosMsg parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            CteDadosMsg object =
                new CteDadosMsg();
            ...
            private  org.apache.axiom.om.OMElement  toOM(CteRecepcaoEventoStub.CteDadosMsg param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(CteRecepcaoEventoStub.CteDadosMsg.MY_QNAME,
            ...
            private  org.apache.axiom.om.OMElement  toOM(CteRecepcaoEventoStub.CteRecepcaoEventoResult param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(CteRecepcaoEventoStub.CteRecepcaoEventoResult.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(CteRecepcaoEventoStub.CteCabecMsgE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(CteRecepcaoEventoStub.CteCabecMsgE.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
                                        ...
                                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, CteRecepcaoEventoStub.CteDadosMsg param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                                        throws org.apache.axis2.AxisFault{
                                                    ...
                                                    try{
                                                            ...
                                                            emptyEnvelope.getBody().addChild(param.getOMElement(CteRecepcaoEventoStub.CteDadosMsg.MY_QNAME,factory));
        ...
        */
        ...
        try {
                ...
                if (CteRecepcaoEventoStub.CteDadosMsg.class.equals(type)){
                
                           return CteRecepcaoEventoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (CteRecepcaoEventoStub.CteRecepcaoEventoResult.class.equals(type)){
                
                           return CteRecepcaoEventoStub.CteRecepcaoEventoResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (CteRecepcaoEventoStub.CteCabecMsgE.class.equals(type)){
                
                           return CteRecepcaoEventoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
