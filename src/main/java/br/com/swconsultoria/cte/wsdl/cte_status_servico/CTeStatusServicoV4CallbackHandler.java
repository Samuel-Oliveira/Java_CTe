/**
 * CTeStatusServicoV4CallbackHandler.java
 *
...
/**
 *  CTeStatusServicoV4CallbackHandler Callback class, Users can extend this class and implement
...
public abstract class CTeStatusServicoV4CallbackHandler {
     ...
     */
    public CTeStatusServicoV4CallbackHandler(Object clientData) {
    ...
    public void receiveResultcteStatusServicoCT(
        br.com.swconsultoria.cte.wsdl.cte_status_servico.CTeStatusServicoV4Stub.CteStatusServicoCTResult result) {
    }
