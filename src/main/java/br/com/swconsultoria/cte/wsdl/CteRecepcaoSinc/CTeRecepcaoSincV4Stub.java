...
public class CTeRecepcaoSincV4Stub extends org.apache.axis2.client.Stub {
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService("CTeRecepcaoSincV4" + getUniqueSuffix());
		...
		__operation.setName(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4",
				"cteRecepcao"));
	...
	public CTeRecepcaoSincV4Stub(org.apache.axis2.context.ConfigurationContext configurationContext,
	 ...
	 * Default Constructor
	 */
	public CTeRecepcaoSincV4Stub() throws org.apache.axis2.AxisFault {

		this("https://cte-homologacao.svrs.rs.gov.br/ws/CTeRecepcaoSincV4/CTeRecepcaoSincV4.asmx");
	 ...
	 */
	public CTeRecepcaoSincV4Stub(java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
	 ...
	 * 
	 * @see br.inf.portalfiscal.www.cte.wsdl.cterecepcaosincv4.CTeRecepcaoSincV4#cteRecepcao
	 * @param cteDadosMsg0
	 * 
	 */
	...
	public CteRecepcaoResult cteRecepcao(
			...
			CTeRecepcaoSincV4Stub.CteDadosMsg cteDadosMsg0)
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), cteDadosMsg0,
					...
					new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4",
							"cteDadosMsg"));
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(),
					CTeRecepcaoSincV4Stub.CteRecepcaoResult.class);

			return (CTeRecepcaoSincV4Stub.CteRecepcaoResult) object;
			...
			if (faultElt != null) {
				if (faultExceptionNameMap
						.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "cteRecepcao"))) {
					// make the fault by reflection
					try {
						java.lang.String exceptionClassName = (java.lang.String) faultExceptionClassNameMap
								.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "cteRecepcao"));
	 ...
	 * 
	 * @see br.inf.portalfiscal.www.cte.wsdl.cterecepcaosincv4.CTeRecepcaoSincV4#startcteRecepcao
	 * @param cteDadosMsg0
	 * 
	 */
	public void startcteRecepcao(

			CTeRecepcaoSincV4Stub.CteDadosMsg cteDadosMsg0,

			final CTeRecepcaoSincV4CallbackHandler callback)
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(),
							CTeRecepcaoSincV4Stub.CteRecepcaoResult.class);
					callback.receiveResultcteRecepcao((CTeRecepcaoSincV4Stub.CteRecepcaoResult) object);

				} catch (org.apache.axis2.AxisFault e) {
					callback.receiveErrorcteRecepcao(e);
				}
			}
				...
				if (error instanceof org.apache.axis2.AxisFault) {
					...
					if (faultElt != null) {
						if (faultExceptionNameMap.containsKey(
								new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "cteRecepcao"))) {
							// make the fault by reflection
							try {
								...
								callback.receiveErrorcteRecepcao(new java.rmi.RemoteException(ex.getMessage(), ex));
							} catch (java.lang.ClassCastException e) {
								// we cannot intantiate the class - throw the original Axis fault
								callback.receiveErrorcteRecepcao(f);
							} catch (java.lang.ClassNotFoundException e) {
								// we cannot intantiate the class - throw the original Axis fault
								callback.receiveErrorcteRecepcao(f);
							} catch (java.lang.NoSuchMethodException e) {
					...
					callback.receiveErrorcteRecepcao(error);
				}
			}
			...
			public void onComplete() {
				try {
					...
					callback.receiveErrorcteRecepcao(axisFault);
				}
			}
		});
	...
	public static class CteRecepcaoResult implements org.apache.axis2.databinding.ADBBean {
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4", "cteRecepcaoResult", "ns1");
		...
		public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					...
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "cteRecepcaoResult",
							xmlWriter);
				}
		...
		private static java.lang.String generatePrefix(java.lang.String namespace) {
			if (namespace.equals("http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4")) {
				return "ns1";
			}
		...
		public static class Factory {
			 ...
			 */
			public static CteRecepcaoResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
					...
					if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
						...
						if (fullTypeName != null) {
							...
							if (!"cteRecepcaoResult".equals(type)) {
								...
								return (CteRecepcaoResult) ExtensionMapper.getTypeObject(nsUri, type, reader);
							}
	...
	public static class CteDadosMsg implements org.apache.axis2.databinding.ADBBean {
		...
		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4", "cteDadosMsg", "ns1");
		...
		public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
			...
			java.lang.String namespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4";
						...
						if (reader.isStartElement()) {
							...
							if (reader.isStartElement()
									&& new javax.xml.namespace.QName(
											"http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSincV4", "cteDadosMsg")
								...
								if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
									throw new org.apache.axis2.databinding.ADBException(
											"The element: " + "cteDadosMsg" + "  cannot be null");
								}

								java.lang.String content = reader.getElementText();

								object.setCteDadosMsg(
	...
	private org.apache.axiom.om.OMElement toOM(CTeRecepcaoSincV4Stub.CteDadosMsg param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(CTeRecepcaoSincV4Stub.CteDadosMsg.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(CTeRecepcaoSincV4Stub.CteRecepcaoResult param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(CTeRecepcaoSincV4Stub.CteRecepcaoResult.MY_QNAME,
					org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			CTeRecepcaoSincV4Stub.CteDadosMsg param, boolean optimizeContent, javax.xml.namespace.QName elementQName)
			throws org.apache.axis2.AxisFault {

		try {

			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
			emptyEnvelope.getBody().addChild(param.getOMElement(CTeRecepcaoSincV4Stub.CteDadosMsg.MY_QNAME, factory));
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param, java.lang.Class type)
		...
		try {
			...
			if (CTeRecepcaoSincV4Stub.CteDadosMsg.class.equals(type)) {

				return CTeRecepcaoSincV4Stub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (CTeRecepcaoSincV4Stub.CteRecepcaoResult.class.equals(type)) {

				return CTeRecepcaoSincV4Stub.CteRecepcaoResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
