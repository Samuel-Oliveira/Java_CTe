 ...
 */
        package br.com.swconsultoria.cte.wsdl.CteRecepcao;
   ...
   public CteRecepcaoStub(org.apache.axis2.context.ConfigurationContext configurationContext,
     ...
     */
    public CteRecepcaoStub(String targetEndpoint) throws org.apache.axis2.AxisFault {
        this(null,targetEndpoint);
                     ...
                     * 
                     * @see br.com.swconsultoria.cte.wsdl.CteRecepcao.CteRecepcao#cteRecepcaoLote
                     * @param cteDadosMsg0
                     ...
                     */
                            ...
                            public  CteRecepcaoStub.CteRecepcaoLoteResult cteRecepcaoLote(

                                    CteRecepcaoStub.CteDadosMsg cteDadosMsg0, CteRecepcaoStub.CteCabecMsgE cteCabecMsg1)
        ...
        _operationClient.execute(true);
               ...
               org.apache.axis2.context.MessageContext _returnMessageContext = _operationClient.getMessageContext(
                ...
                org.apache.axiom.soap.SOAPEnvelope _returnEnv = _returnMessageContext.getEnvelope();
                                ...
                                Object object = fromOM(
                                             ...
                                             CteRecepcaoStub.CteRecepcaoLoteResult.class,
                                              getEnvelopeNamespaces(_returnEnv));

                               
                                        return (CteRecepcaoStub.CteRecepcaoLoteResult)object;
            ...
            if (faultElt!=null){
                if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"cteRecepcaoLote"))){
                    ...
                    try{
                        String exceptionClassName = (String)faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"cteRecepcaoLote"));
                        Class exceptionClass = Class.forName(exceptionClassName);
                        java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(String.class);
                        Exception ex = (Exception) constructor.newInstance(f.getMessage());
                        //message class
                        String messageClassName = (String)faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"cteRecepcaoLote"));
                ...
                * 
                * @see br.com.swconsultoria.cte.wsdl.CteRecepcao.CteRecepcao#startcteRecepcaoLote
                    * @param cteDadosMsg0
                ...
                */
                public  void startcteRecepcaoLote(
                        ...
                        final CteRecepcaoCallbackHandler callback)
                        ...
                        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                            ...
                            try {
                                org.apache.axiom.soap.SOAPEnvelope resultEnv = resultContext.getEnvelope();
                                        ...
                                        (CteRecepcaoStub.CteRecepcaoLoteResult)object);
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   String namespacePrefix = registerPrefix(xmlWriter,"http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao");
    ...
    public static class Factory{
        ...
        *                If this object is a complex type, the reader is positioned at the end element of its outer element
        */
        public static CteRecepcaoLoteResult parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            ...
            private  org.apache.axiom.om.OMElement  toOM(CteRecepcaoStub.CteDadosMsg param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(CteRecepcaoStub.CteDadosMsg.MY_QNAME,
            ...
            private  org.apache.axiom.om.OMElement  toOM(CteRecepcaoStub.CteRecepcaoLoteResult param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(CteRecepcaoStub.CteRecepcaoLoteResult.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(CteRecepcaoStub.CteCabecMsgE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(CteRecepcaoStub.CteCabecMsgE.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
                                        ...
                                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, CteRecepcaoStub.CteDadosMsg param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                                        throws org.apache.axis2.AxisFault{
                                                    ...
                                                    try{
                                                            ...
                                                            emptyEnvelope.getBody().addChild(param.getOMElement(CteRecepcaoStub.CteDadosMsg.MY_QNAME,factory));
        ...
        */
        ...
        try {
                ...
                if (CteRecepcaoStub.CteDadosMsg.class.equals(type)){
                
                           return CteRecepcaoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (CteRecepcaoStub.CteRecepcaoLoteResult.class.equals(type)){
                
                           return CteRecepcaoStub.CteRecepcaoLoteResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (CteRecepcaoStub.CteCabecMsgE.class.equals(type)){
                
                           return CteRecepcaoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
