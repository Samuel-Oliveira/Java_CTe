...
public class CteRecepcaoStub extends org.apache.axis2.client.Stub {
     ...
     */
    public CteRecepcaoStub(java.lang.String targetEndpoint)
        throws org.apache.axis2.AxisFault {
    ...
    private void populateAxisService() throws org.apache.axis2.AxisFault {
        ...
        _service = new org.apache.axis2.description.AxisService("CteRecepcao" +
                getUniqueSuffix());
     ...
     *
     * @see br.com.swconsultoria.cte.wsdl.cteRetRecepcao.CteRecepcao#cteRecepcaoLote
     * @param cteDadosMsg0
     * @param cteCabecMsg1
     */
    public CteRecepcaoStub.CteRecepcaoLoteResult cteRecepcaoLote(
        CteRecepcaoStub.CteDadosMsg cteDadosMsg0,
        CteRecepcaoStub.CteCabecMsgE cteCabecMsg1)
        ...
        try {
            ...
            _operationClient.getOptions()
                            .setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao/cteRecepcaoLote");
            ...
            if (faultElt != null) {
                if (faultExceptionNameMap.containsKey(
                            new org.apache.axis2.client.FaultMapKey(
                                faultElt.getQName(), "cteRecepcaoLote"))) {
     ...
     *
     * @see br.com.swconsultoria.cte.wsdl.cteRetRecepcao.CteRecepcao#startcteRecepcaoLote
     * @param cteDadosMsg0
     * @param cteCabecMsg1
     */
                ...
                public void onMessage(
                    ...
                    try {
                        ...
                        java.lang.Object object = fromOM(resultEnv.getBody()
                                                                  .getFirstElement(),
                                CteRecepcaoStub.CteRecepcaoLoteResult.class);
                        callback.receiveResultcteRecepcaoLote((CteRecepcaoStub.CteRecepcaoLoteResult) object);
                        ...
                        if (faultElt != null) {
                            if (faultExceptionNameMap.containsKey(
                                ...
                                try {
                                    ...
                                    callback.receiveErrorcteRecepcaoLote(new java.rmi.RemoteException(
                                            ex.getMessage(), ex));
                                } catch (java.lang.ClassCastException e) {
                                    // we cannot intantiate the class - throw the original Axis fault
    ...
    private org.apache.axiom.om.OMElement toOM(
        CteRecepcaoStub.CteDadosMsg param,
    ...
    private org.apache.axiom.om.OMElement toOM(
        CteRecepcaoStub.CteRecepcaoLoteResult param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.om.OMElement toOM(
        CteRecepcaoStub.CteCabecMsgE param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    CteRecepcaoStub.CteDadosMsg.MY_QNAME,
                    factory));
    ...
    public static class CteCabecMsgE implements org.apache.axis2.databinding.ADBBean {
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao",
                "cteCabecMsg", "ns1");
    ...
    public static class ExtensionMapper {
        public static java.lang.Object getTypeObject(
            ...
            if ("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao".equals(
    ...
    public static class CteRecepcaoLoteResult implements org.apache.axis2.databinding.ADBBean {
        ...
        public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            if (serializeType) {
                ...
                if ((namespacePrefix != null) &&
                    ...
                    writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        namespacePrefix + ":cteRecepcaoLoteResult", xmlWriter);
                } else {
                    writeAttribute("xsi",
                        "http://www.w3.org/2001/XMLSchema-instance", "type",
                        "cteRecepcaoLoteResult", xmlWriter);
                }
            }
        ...
        public static class Factory {
             ...
             *                If this object is a complex type, the reader is positioned at the end element of its outer element
             */
            public static CteRecepcaoLoteResult parse(
                javax.xml.stream.XMLStreamReader reader)
                throws java.lang.Exception {
                CteRecepcaoLoteResult object = new CteRecepcaoLoteResult();
                    ...
                    if (reader.getAttributeValue(
                        ...
                        if (fullTypeName != null) {
                            ...
                            if (!"cteRecepcaoLoteResult".equals(type)) {
                                ...
                                return (CteRecepcaoLoteResult) ExtensionMapper.getTypeObject(nsUri,
                                    type, reader);
                            }
                        }
                    }
