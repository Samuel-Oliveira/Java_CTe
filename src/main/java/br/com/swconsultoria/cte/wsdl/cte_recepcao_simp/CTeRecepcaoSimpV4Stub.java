...
public class CTeRecepcaoSimpV4Stub extends org.apache.axis2.client.Stub {
    ...
    public CTeRecepcaoSimpV4Stub(
        ...
        this(configurationContext,
            "http://cte.sefaz.mt.gov.br/cte-ws/services/CTeRecepcaoSimpV4");
    }

    /**
     * Default Constructor
     */
    public CTeRecepcaoSimpV4Stub() throws org.apache.axis2.AxisFault {
        this("http://cte.sefaz.mt.gov.br/cte-ws/services/CTeRecepcaoSimpV4");
    }

    /**
     * Constructor taking the target endpoint
     */
    public CTeRecepcaoSimpV4Stub(String targetEndpoint)
        throws org.apache.axis2.AxisFault {
     ...
     *
     * @see br.com.swconsultoria.cte.schema_400.CTeRecepcaoSimpV4#cteRecepcaoSimp
     * @param cteDadosMsg0
     */
    public CteRecepcaoSimpResult cteRecepcaoSimp(
        CteDadosMsg cteDadosMsg0)
        ...
        try {
            ...
            Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    CteRecepcaoSimpResult.class);

            return (CteRecepcaoSimpResult) object;
     ...
     *
     * @see br.com.swconsultoria.cte.schema_400.CTeRecepcaoSimpV4#startcteRecepcaoSimp
     * @param cteDadosMsg0
     */
    public void startcteRecepcaoSimp(
        CteDadosMsg cteDadosMsg0,
        final CTeRecepcaoSimpV4CallbackHandler callback)
        throws java.rmi.RemoteException {
        org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
        _operationClient.getOptions()
                        .setAction("http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSimpV4/cteRecepcaoSimp");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                public void onMessage(
                    ...
                    try {
                        ...
                        Object object = fromOM(resultEnv.getBody()
                                                                  .getFirstElement(),
                                CteRecepcaoSimpResult.class);
                        callback.receiveResultcteRecepcaoSimp((CteRecepcaoSimpResult) object);
                    } catch (org.apache.axis2.AxisFault e) {
                        callback.receiveErrorcteRecepcaoSimp(e);
                    }
                }
                ...
                public void onError(Exception error) {
                    if (error instanceof org.apache.axis2.AxisFault) {
                        ...
                        if (faultElt != null) {
                            if (faultExceptionNameMap.containsKey(
                                ...
                                try {
                                    ...
                                    callback.receiveErrorcteRecepcaoSimp(new java.rmi.RemoteException(
                                            ex.getMessage(), ex));
                                } catch (ClassCastException e) {
                                    // we cannot intantiate the class - throw the original Axis fault
                                    callback.receiveErrorcteRecepcaoSimp(f);
                                } catch (ClassNotFoundException e) {
                                    // we cannot intantiate the class - throw the original Axis fault
                                    callback.receiveErrorcteRecepcaoSimp(f);
                                } catch (NoSuchMethodException e) {
                        ...
                        callback.receiveErrorcteRecepcaoSimp(error);
                    }
                }
                ...
                public void onComplete() {
                    try {
                        ...
                        callback.receiveErrorcteRecepcaoSimp(axisFault);
                    }
                }
            });
    ...
    private org.apache.axiom.om.OMElement toOM(
        CteRecepcaoSimpResult param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(CteRecepcaoSimpResult.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private Object fromOM(org.apache.axiom.om.OMElement param,
        ...
        try {
            ...
            if (CteRecepcaoSimpResult.class.equals(
                        type)) {
                return CteRecepcaoSimpResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
        } catch (Exception e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    public static class CteDadosMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            String namespace = "http://www.portalfiscal.inf.br/cte/wsdl/CTeRecepcaoSimpV4";
