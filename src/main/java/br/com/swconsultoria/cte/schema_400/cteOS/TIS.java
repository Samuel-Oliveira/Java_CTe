...
@XmlType(name = "TIS", namespace = "http://www.portalfiscal.inf.br/cte", propOrder = {
    "cstis",
    "cClassTribIS",
    "vbcis",
    "pis",
...
public class TIS {
    ...
    @XmlElement(name = "CSTIS", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
    protected String cstis;
    @XmlElement(namespace = "http://www.portalfiscal.inf.br/cte", required = true)
    protected String cClassTribIS;
    @XmlElement(name = "vBCIS", namespace = "http://www.portalfiscal.inf.br/cte")
    protected String vbcis;
    @XmlElement(name = "pIS", namespace = "http://www.portalfiscal.inf.br/cte")
    protected String pis;
    @XmlElement(name = "pISEspec", namespace = "http://www.portalfiscal.inf.br/cte")
    protected String pisEspec;
    @XmlElement(namespace = "http://www.portalfiscal.inf.br/cte")
    protected String uTrib;
    @XmlElement(namespace = "http://www.portalfiscal.inf.br/cte")
    protected String qTrib;
    @XmlElement(name = "vIS", namespace = "http://www.portalfiscal.inf.br/cte")
