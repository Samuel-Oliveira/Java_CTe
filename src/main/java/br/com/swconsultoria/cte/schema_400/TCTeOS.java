...
public class TCTeOS {
    ...
    public static class InfCte {
        ...
        protected TCTeOS.InfCte.PgtoVinc pgtoVinc;
         ...
         * @return
         *     possible object is
         *     {@link TCTeOS.InfCte.PgtoVinc }
         *     
         */
        public TCTeOS.InfCte.PgtoVinc getPgtoVinc() {
            return pgtoVinc;
        }
         ...
         *     
         */
        public void setPgtoVinc(TCTeOS.InfCte.PgtoVinc value) {
            this.pgtoVinc = value;
        }
