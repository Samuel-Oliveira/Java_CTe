...
package br.com.swconsultoria.cte.schema_400.cteOS;
...
@XmlType(name = "TIBSCBSMonoTot", namespace = "http://www.portalfiscal.inf.br/cte", propOrder = {
    "vbcibscbs",
    "gibs",
    "gcbs",
    "gMono"
...
public class TIBSCBSMonoTot {
    ...
    @XmlElement(name = "vBCIBSCBS", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
    protected String vbcibscbs;
    @XmlElement(name = "gIBS", namespace = "http://www.portalfiscal.inf.br/cte")
    protected TIBSCBSMonoTot.GIBS gibs;
    @XmlElement(name = "gCBS", namespace = "http://www.portalfiscal.inf.br/cte")
    ...
    public static class GCBS {
        ...
        @XmlElement(name = "vCBS", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
    ...
    public static class GIBS {
        ...
        @XmlElement(name = "gIBSUF", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
        protected TIBSCBSMonoTot.GIBS.GIBSUF gibsuf;
        @XmlElement(name = "gIBSMun", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
        protected TIBSCBSMonoTot.GIBS.GIBSMun gibsMun;
        @XmlElement(name = "vIBS", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
        ...
        public static class GIBSMun {
            ...
            @XmlElement(namespace = "http://www.portalfiscal.inf.br/cte", required = true)
            protected String vDevTrib;
            @XmlElement(name = "vIBSMun", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
        ...
        public static class GIBSUF {
            ...
            @XmlElement(namespace = "http://www.portalfiscal.inf.br/cte", required = true)
            protected String vDevTrib;
            @XmlElement(name = "vIBSUF", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
    ...
    public static class GMono {
        ...
        @XmlElement(name = "vIBSMono", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
        protected String vibsMono;
        @XmlElement(name = "vCBSMono", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
        protected String vcbsMono;
        @XmlElement(name = "vIBSMonoReten", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
        protected String vibsMonoReten;
        @XmlElement(name = "vCBSMonoReten", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
        protected String vcbsMonoReten;
        @XmlElement(name = "vIBSMonoRet", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
        protected String vibsMonoRet;
        @XmlElement(name = "vCBSMonoRet", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
