...
@XmlType(name = "TTribRegular", namespace = "http://www.portalfiscal.inf.br/cte", propOrder = {
    "cstReg",
    "cClassTribReg",
    "pAliqEfetRegIBSUF",
    "vTribRegIBSUF",
...
public class TTribRegular {
    ...
    @XmlElement(name = "CSTReg", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
