...
@XmlType(name = "TIBSCBSTot", namespace = "http://www.portalfiscal.inf.br/cte", propOrder = {
    "vbcibscbs",
    "gibs",
    "gcbs"
})
public class TIBSCBSTot {
    ...
    @XmlElement(name = "gIBS", namespace = "http://www.portalfiscal.inf.br/cte", required = true)
