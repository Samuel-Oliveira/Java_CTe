...
Para Iniciar : 
- Caso use Libs baixe o java-cte-3.00.6.jar (https://github.com/Samuel-Oliveira/Java_CTe/raw/master/java-cte-3.00.6.jar) e o adicione às bibliotecas de Seu Projeto.
